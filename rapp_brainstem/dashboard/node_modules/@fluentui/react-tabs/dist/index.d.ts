...
export declare type TabBaseProps = Omit<TabProps, 'contentReservedSpace'>;

export declare type TabBaseState = Omit<TabState, 'appearance' | 'size' | 'contentReservedSpace'>;
