...
export declare type MessageBarBaseProps = DistributiveOmit<MessageBarProps, 'shape'>;

export declare type MessageBarBaseState = DistributiveOmit<MessageBarState, 'shape'>;
...
export declare type MessageBarBodyContextValues = {
    link: {
        inline?: boolean;
    };
};
 ...
 */
export declare const renderMessageBar_unstable: (state: MessageBarBaseState, contexts: MessageBarContextValues) => JSXElement;
 ...
 * @param ref - reference to root HTMLElement of MessageBar
 */
export declare const useMessageBarBase_unstable: (props: MessageBarBaseProps, ref: React_2.Ref<HTMLDivElement>) => MessageBarBaseState;
...
export declare function useMessageBarBodyContextValues_unstable(state: MessageBarBodyState): MessageBarBodyContextValues;
