...
import { DeloserFocusLostEvent, DeloserRestoreFocusEventName, TabsterMoveFocusEvent, } from "./Events.js";
import { documentContains, getElementUId, isDisplayNone, TabsterPart, WeakHTMLElement, } from "./Utils.js";
import { dom } from "./DOMAPI.js";
const _containerHistoryLength = 10;
export class DeloserItemBase {
}
export class DeloserItem extends DeloserItemBase {
    uid;
    _tabster;
    _deloser;
...
export class DeloserHistoryByRootBase {
    _tabster;
    _history = [];
    rootUId;
    ...
    if ((process.env.NODE_ENV === 'development')) {
        ...
        if (element) {
            if (remove) {
                ...
                element.style.setProperty("--tabster-deloser", (isActive ? "active" : "inactive") +
                    "," +
...
export class Deloser extends TabsterPart {
    uid;
    strategy;
    _isActive = false;
    _history = [[]];
        ...
        const restoreFocus = async () => {
            ...
            if (curDeloser) {
                ...
                if (curDeloser.strategy === DeloserStrategies.Manual) {
                    ...
                    if (el &&
                        (!curDeloserElement?.dispatchEvent(new TabsterMoveFocusEvent({
                            by: "deloser",
