...
Object.defineProperty(exports, "OutlineAPI", {
    enumerable: true,
    get: function() {
        return OutlineAPI;
    }
...
class OutlineAPI {
    ...
    _setOutlinePosition() {
        ...
        let boundingRect = (0, _Utils.getBoundingRect)(this._win, this._outlinedElement);
        ...
        for(let parent = this._outlinedElement.parentElement; parent && parent.nodeType === Node.ELEMENT_NODE; parent = parent.parentElement){
            ...
            boundingRect = (0, _Utils.getBoundingRect)(this._win, parent);
        ...
        const allRect = (0, _Utils.getBoundingRect)(this._win, scrollingElement);
...
function appendStyles(document1, props) {
    const style = document1.createElement("style");
    style.type = "text/css";
    style.appendChild(document1.createTextNode(getOutlineStyles(props)));
