...
_export(exports, {
    get ShadowTreeWalker () {
        return ShadowTreeWalker;
    },
    get createShadowTreeWalker () {
...
function getLastChild(container) {
    let lastChild = null;
    for(let i = (0, _DOMFunctions.getLastElementChild)(container); i; i = (0, _DOMFunctions.getLastElementChild)(i)){
        lastChild = i;
    }
...
class ShadowTreeWalker {
    ...
    set currentNode(node) {
        if (!(0, _DOMFunctions.nodeContains)(this.root, node)) {
